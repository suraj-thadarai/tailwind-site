...
const Pricing = () => {
  return (
    <section id='pricing' className='w-full bg-slate-200 flex-col justify-center items-start h-fit px-7 py-14 lg:20 gap-5'>
      ...
      <div className='flex flex-col lg:flex-row gap-6 lg:gap-20 justify-between items-start w-full mt-5'>
        <p className='text-slate-950 text-2xl'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ratione quam quis atque fugiat totam excepturi debitis placeat quae a pariatur?</p>
      ...
      <div className='w-full justify-around items-center flex flex-wrap gap-10 mt-20'>
        {
          pricing.map((price)=>(
